...
export class AlertsController {
  ...
  createWarning(@Body() dto: CreateWarningAlertDto): Alert {
  ...
  @ApiCreatedResponse({ schema: alertSchema })
  createScheduled(@Body() dto: CreateScheduledAlertDto): Alert {
  ...
  convertToIncident(@Param('id') id: string, @Body() dto: ConvertAlertToIncidentDto): {
    incident: Incident;
    alert: Alert;
    sourceAlert: Alert;
  } {
